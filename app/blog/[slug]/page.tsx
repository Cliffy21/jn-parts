        ...
        {isCarWrapKenyaPost ? (
          <div className="space-y-8">
            <p className="text-zinc-300 text-base leading-relaxed">
              ...
              to modern vinyl wraps. These wraps come in a variety of finishes
              whether you prefer a sleek gloss or a matte look making them a
              flexible option for personalizing your vehicle.
            </p>
            <p className="text-zinc-300 text-base leading-relaxed">
              So, how much does car wrapping cost in Kenya?
            </p>
            <p className="text-zinc-300 text-base leading-relaxed">
              On average, a full car wrap in Kenya costs between KES 75,000 and
              KES 95,000, depending on the size of the vehicle, type of vinyl and
              installer expertise.
            </p>
            <p className="text-zinc-300 text-base leading-relaxed">
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-2 text-zinc-300 text-sm leading-relaxed mb-5">
                <li>Full wrap (cars): KES 85,000</li>
                <li>Full wrap (SUVs): KES 95,000</li>
                <li>Paint Protection Film (PPF): KES 150,000 - 180,000</li>
              ...
              <div className="overflow-x-auto rounded-xl border border-zinc-800">
                <table className="min-w-full text-sm text-left text-zinc-300">
                  ...
                  <tbody className="divide-y divide-zinc-800">
                    ...
                    <tr>
                      <td className="px-4 py-3">Paint Protection Film (PPF)</td>
              ...
              <p className="text-zinc-400 text-sm leading-relaxed mt-4">
                Car wrap prices in Nairobi and nearby areas like Kiambu may vary
                slightly depending on the installer and materials used.
              </p>
            </div>
            ...
            <div>
              ...
              <ol className="list-decimal pl-5 space-y-3 text-zinc-400 text-sm leading-relaxed">
                <li>
                  ...
                  Standard vinyl wraps are more affordable, while premium wraps
            ...
            <div>
              ...
              <ol className="list-decimal pl-5 space-y-3 text-zinc-400 text-sm leading-relaxed">
                <li>
                  ...
                  Car wraps act as a protective layer, shielding your vehicle
                  from UV rays, fading, and minor scratches commonly experienced
                  on Kenyan roads.
                </li>
                <li>
                  <span className="text-zinc-200 font-medium">
            ...
            <div>
              ...
              <ol className="list-decimal pl-5 space-y-3 text-zinc-400 text-sm leading-relaxed">
                <li>
                  ...
                  Car wraps typically last 5-7 years, which is shorter compared
            ...
            <div>
              ...
              <p className="text-zinc-400 text-sm leading-relaxed mb-3">
                Car wrapping services are widely available in major towns like
              ...
              <p className="text-zinc-400 text-sm leading-relaxed">
                ...
                Parts and Accessories offers a range of solutions to enhance both
                the look and performance of your car.
              </p>
            </div>
            ...
            <div>
              ...
              <ol className="list-decimal pl-5 space-y-3 text-zinc-400 text-sm leading-relaxed">
                <li>
                  ...
                  regulations set by the National Transport and Safety Authority
                  (NTSA).
                </li>
                <li>
                  <span className="text-zinc-200 font-medium">
                ...
                <li>
                  ...
                  Wrapping is generally more affordable than painting, especially
                  for temporary or customizable designs.
                </li>
                <li>
                  <span className="text-zinc-200 font-medium">
                    How long does a car wrap last?
                  </span>{" "}
                  A high-quality wrap lasts between 5-7 years with proper care.
                </li>
              </ol>
            </div>
          </div>
          ...
          <div className="space-y-8">
            <p className="text-zinc-300 text-base leading-relaxed">
              ...
              lead to scratches, dents or costly repairs.
            </p>
            <p className="text-zinc-300 text-base leading-relaxed">
            ...
            <div>
              ...
              <p className="text-zinc-400 text-sm leading-relaxed mb-3">
                At JN Parts and Accessories, you can get professional
                installation services that ensure:
              </p>
              <ul className="list-disc pl-5 space-y-2 text-zinc-400 text-sm leading-relaxed">
            ...
            <div>
              ...
              <ol className="list-decimal pl-5 space-y-3 text-zinc-400 text-sm leading-relaxed">
                <li>
                  ...
                  areas, and heavy traffic. It helps reduce scratches, accidents,
                  and parking stress.
                </li>
                <li>
                  <span className="text-zinc-200 font-medium">
                  ...
                  installer can advise on compatibility for your specific
                  vehicle.
                </li>
                <li>
                  <span className="text-zinc-200 font-medium">
